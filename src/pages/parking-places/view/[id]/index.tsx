...
import { getParkingPlaceById } from 'apiSdk/parking-places';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Parking Place Detail View
          </Text>
          {hasAccess('parking_place', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/parking-places/edit/${data?.id}`} passHref legacyBehavior>
              <Button
